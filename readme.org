...
#+begin_src sh
  # DNF5 packages
  $ sudo dnf install python go ripgrep fd \
    jetbrains-mono-fonts git zsh gopls clang \
    ccmake make

  # Python packages
  $ pip install --user basedpyright epc orjson sexpdata six \
    setuptools paramiko rapidfuzz watchdog packaging
#+end_src
...
** feature-terminal-emulator feature-eat
...
** feature-completion feature-consult feature-marginalia
...
** feature-lsp feature-lsp-mode feature-lsp-bridge
